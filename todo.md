...
- [x] Task 10: Implement Macie organization configuration that enables Macie in a delegated admin account, configures member accounts, sets up publishing destinations for findings, and handles disabling Macie when requested.
